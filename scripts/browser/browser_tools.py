#!/usr/bin/env python3
"""
Claude Code callable shim — thin wrappers around browser_engine + eyes + hands + auth.
...
Usage from Claude Code session:
    import sys; sys.path.insert(0, '/Users/nayslayer/openclaw/.claude/worktrees/xenodochial-grothendieck/scripts')
