...
Usage:
    ...
    python repo_analyst.py --model gemma4:26b        # specify model (default gemma4:26b)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default=DEFAULT_MODEL, help="Ollama model (default gemma4:26b)")
